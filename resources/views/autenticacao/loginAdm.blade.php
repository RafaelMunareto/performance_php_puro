...
@section('title', 'Login_adm')
@section('conteudo')
@section('titulo') LOGIN ADMINISTRATIVO @endsection
...
<div id='desktop' class='animated fadeIn' >
    ...
    <div class='d-flex flex-column justify-content-center container mt-5 mb-5'>
        ...
        <div class='d-flex justify-content-center'>
            <a href="{{ route('registrar', 1) }}" class='neomorphic-text-black margin-1 padding-1 borderRadius-20 mt-4 buttonTransform animated-bounce-buttom'><i class="fas fa-unlock"></i> REGISTRE-SE </a>
...
<div id='mobile'>
    ...
    <div class='d-flex flex-column justify-content-center container mt-5 mb-5 '>
        <form method='POST' class='d-flex justify-content-center align-center flex-column'>
            ...
            <div class='row'>
                <a href="{{ route('registrar', 1) }}" class='neomorphic-text-black margin-1 col-12 animated-bounce-buttom'><i class="neomorphic-text-black fas fa-unlock"></i> REGISTRE-SE </a>
