...
@foreach($notas as $linha)
    <div id='cars-notas' class='neomorphic-card padding-1 margin-2 borderRadius-20 d-flex flex-column text-center animated flipInX'>
        <span class='size120 font-weight-bold neomorphic-text-black '>NOTA FINAL</span>
...
@if($sprintCount > 0)
    <div id='cars-notas' class='neomorphic-conc padding-1 margin-2 borderRadius-20 d-flex flex-column text-center animated flipInX'>
        <span class='size120 font-weight-bold neomorphic-text-black'>SPRINTS</span>
        <div class='d-flex justify-content-center row'>
...
@endif
 @if($prioritarioCount <> 0):
    <div id='cars-notas' class='neomorphic-conc padding-1 margin-2 borderRadius-20 d-flex flex-column text-center animated flipInX'>
        <span class='size120 font-weight-bold neomorphic-text-black'>PRIORITÁRIOS</span>
        <div class='d-flex justify-content-center row'>
...
@if($direcionadorCount > 0)
    <div id='cars-notas' class='neomorphic-conc padding-1 margin-2 borderRadius-20 d-flex flex-column text-center animated flipInX'>
        <span class='size120 font-weight-bold neomorphic-text-black'>DIRECIONADORES</span>
        <div class='d-flex justify-content-center row'>
