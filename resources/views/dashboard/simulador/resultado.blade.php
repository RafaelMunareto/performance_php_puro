...
<div class='neomorphic-conc d-flex justify-content-around borderRadius-20 neomorphic-div  height-100' >

@if($sprintCount >0)
    <div class='neomorphic-card borderRadius-20 d-flex justify-content-around flex-column height-100 mt-4 margin-05'>
        <h4 class="text-uppercase neomorphic-text-gray padding-1">SPRINTS</h4>
        <div @if($count < 3) id='cards-resultado_um_terco_int' @else id='cards-resultadoS' @endif >
            @foreach($sprint as $linha)
                <div @if($count < 3) id='cards-resultado_um_terco_intSprint' @endif class='neomorphic-conc borderRadius-20 padding-07 margin-05 text-center'>
                    <div class='d-flex justify-content-between align-center'>
                        <span class='neomorphic-text-black text-center text-uppercase size80 padding-05'>{{$linha->nome_item}}</span>
                        <input class='{{$linha->cod_item}} inputSimulador neomorphic-input borderRadius-10 col-3 size90 text-center padding-05 color-text-val'
...
@if($prioritarioCount >0)
    ...
    <div  class='neomorphic-card borderRadius-20 d-flex justify-content-around flex-column height-100 mt-4 flex-wrap margin-05'>
        <h4 class="text-uppercase neomorphic-text-gray padding-1">PRIORITÁRIOS</h4>
        <div @if($count < 3) id='cards-resultado_um_terco' @else id='cards-resultadoS' @endif >
            @foreach($prioritario as $linha)
                <div @if($count < 3) id='cards-resultado_um_terco_int' @endif class='neomorphic-conc borderRadius-20 padding-07 margin-05 text-center'>
                    <div class='d-flex justify-content-between align-center'>
                        <span class='neomorphic-text-black text-center text-uppercase size80 padding-05'>{{$linha->nome_item}}</span>
                        <input class='{{$linha->cod_item}} inputSimulador neomorphic-input borderRadius-10 col-3 size90 text-center padding-05 color-text-val'
        ...
        <div @if($count < 3) id='cards-resultado_um_terco' @else id='cards-resultadoS' @endif >
            @foreach($direcionador as $linha)
                <div @if($count < 3) id='cards-resultado_um_terco_int' @endif class='neomorphic-conc borderRadius-20 padding-07 margin-05 text-center'>
                    <div class='d-flex justify-content-between align-center'>
                        <span class='neomorphic-text-black text-center text-uppercase size80 padding-05'>{{$linha->nome_item}}</span>
                        <input class='{{$linha->cod_item}} inputSimulador neomorphic-input borderRadius-10 col-3 size90 text-center padding-05 color-text-val size80'
