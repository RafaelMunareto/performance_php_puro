...
<div id='desktop' class='animated fadeIn' >
    ...
    <div class='neomorphic-card borderRadius-20 d-flex justify-content-around flex-column align-middle mb-5 height-100 width-50rem padding-05 size90' >
        ...
        <div class='row font-weight-bold'>
            <div class='d-flex justify-content-center neomorphic-card borderRadius-10 padding-05 mr-2 mt-2 ml-4 mb-2 col-6'>
                <span class='neomorphic-text-black text-bold text-center size90'>{{'NOME'}}</span>
            </div>

            <div class='neomorphic-card size70 borderRadius-10 padding-05 mr-1 mt-2 ml-1 mb-2 col-2'>
            ...
            <div class='neomorphic-card size80 borderRadius-10 padding-05 mr-1 mt-2 ml-1 mb-2 col-1 text-center'>
                <span class='text-center align-vertical'>{{'%'}}</span>
            </div>
        </div>

        @foreach($cadastro as $linha)
            <a href='/dashboard_adm/index/{{$linha->cod_func}}'>
                <div @if($linha->cod_func == $cod_func) class='row font-weight-bold' @else class='row' @endif >
                    <div class='neomorphic-conc size70 borderRadius-10 padding-05 mr-2 mt-2 ml-4 mb-2 col-6'>
                        <span class='neomorphic-text-black text-center text-uppercase'>{{$linha->nome_func}}</span>
                    </div>

                    <div class='neomorphic-conc size70 borderRadius-10 padding-05 mr-1 mt-2 ml-1 mb-2 col-2'>
                    ...
                    <div class='neomorphic-conc size80 borderRadius-10 padding-05 mr-1 mt-2 ml-1 mb-2 col-1 text-center'>
