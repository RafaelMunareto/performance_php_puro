...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <div class='d-flex justify-content-between mt-3 mr-3' id='desktop' >
        ...
        <div class='d-flex justify-content-center flex-column'>
            <h4 class='neomorphic-text-gray text-uppercase ml-3' id='mobile'>@yield('titulo')</h4>
            <div  id='mobile'>@yield('navgationM')</div>
        </div>

        <div class='container-fluid d-flex justify-content-center margin-05'>
            @include('message.flash-message')
        </div>

        <div class='container-fluid margin-0'>@yield('conteudo')</div>

        <div class='container-fluid margin-0' id='mobile'>@yield('conteudoM')</div>
    ...
    <footer  class="page-footer font-small blue pt-4 neomorphic-conc footer">
        ...
        {{-- auth da API --}}
            <div class='vue'>
                <vc-logout check='{{ Auth::check() }}'></vc-logout>
            </div>
        {{-- fim auth da API --}}
