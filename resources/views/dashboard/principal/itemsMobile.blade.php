    ...
    <div id='cards-resultadoM' class='neomorphic-card borderRadius-20 d-flex justify-content-around flex-column mb-5 height-100 '>
                ...
                <div class='d-flex justify-content-between align-center'>
                    ...
                    <span class='padding-1'>
                        <li class="icon-item margin-0 padding-0 ">
                            <a href="{{ route('dashboard.propriedade', [$linha->cod_item, $dta]) }}" class="icon-link borderRadius-10 borderRadius-10 padding-05 neomorphic-text-blue animated-bounce-buttom" title="Propriedades">
